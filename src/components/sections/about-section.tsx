      ...
      <div className="wrap grid items-start gap-[clamp(40px,6vw,100px)] min-[880px]:grid-cols-[0.8fr_1.2fr]">
        ...
        <div>
          <p className="serif border-l-[3px] border-pink-500 pl-6 text-[clamp(1.4rem,2.2vw,1.9rem)] leading-[1.35] text-ink">
            Founded in 2024, The Pink and White Empowerment Initiative
            confronts a stubborn problem: too many people lack access to
            accurate health information and the basic products that make
            wellness possible.
          </p>
          <div className="body-cols mt-8 text-[1rem] leading-[1.7] text-ink-soft">
            <p>
              TPAWI&apos;s mission is to empower communities by addressing
              public health challenges and reducing health illiteracy across
              all ages and genders. Through essential health education,
              resources, and community-based programs, we strive to create
              healthier, informed populations.
            </p>
            <p className="mt-3.5">
          ...
          <div className="mt-9 flex items-center gap-3.5">
            <div>
              <div className="serif italic text-[1.1rem]">
